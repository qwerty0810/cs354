...
00001295 <main>:
    ...
    12d2:	be 00 00 00 00       	mov    esi,0x0
    ...
    130d:	8d 46 01             	lea    eax,[esi+0x1]
    1310:	50                   	push   eax
    1311:	ff b5 d0 fd ff ff    	push   DWORD PTR [ebp-0x230]
    1317:	6a 01                	push   0x1
    1319:	e8 a2 fd ff ff       	call   10c0 <__printf_chk@plt>
    131e:	83 c4 10             	add    esp,0x10
    1321:	eb 14                	jmp    1337 <main+0xa2>
    1323:	e8 e5 fe ff ff       	call   120d <fail>
    1328:	83 fe 04             	cmp    esi,0x4
    132b:	7f 42                	jg     136f <main+0xda>
    132d:	8b 85 d4 fd ff ff    	mov    eax,DWORD PTR [ebp-0x22c]
    1333:	39 38                	cmp    DWORD PTR [eax],edi
    1335:	74 d3                	je     130a <main+0x75>
    1337:	83 ec 04             	sub    esp,0x4
    133a:	57                   	push   edi
    133b:	68 00 02 00 00       	push   0x200
    1340:	8d 85 e4 fd ff ff    	lea    eax,[ebp-0x21c]
    1346:	50                   	push   eax
    1347:	e8 14 fd ff ff       	call   1060 <fgets@plt>
    134c:	83 c4 10             	add    esp,0x10
    134f:	85 c0                	test   eax,eax
    1351:	74 d5                	je     1328 <main+0x93>
    1353:	83 ec 08             	sub    esp,0x8
    1356:	ff b4 b3 50 00 00 00 	push   DWORD PTR [ebx+esi*4+0x50]
    135d:	50                   	push   eax
    135e:	e8 dd fc ff ff       	call   1040 <strcmp@plt>
    1363:	83 c4 10             	add    esp,0x10
    1366:	85 c0                	test   eax,eax
    1368:	75 b9                	jne    1323 <main+0x8e>
    136a:	83 c6 01             	add    esi,0x1
    136d:	eb b9                	jmp    1328 <main+0x93>
    136f:	e8 e0 fe ff ff       	call   1254 <success>
    1374:	8b 45 e4             	mov    eax,DWORD PTR [ebp-0x1c]
    1377:	65 2b 05 14 00 00 00 	sub    eax,DWORD PTR gs:0x14
    137e:	75 11                	jne    1391 <main+0xfc>
    1380:	b8 00 00 00 00       	mov    eax,0x0
    1385:	8d 65 f0             	lea    esp,[ebp-0x10]
    1388:	59                   	pop    ecx
    1389:	5b                   	pop    ebx
    138a:	5e                   	pop    esi
    138b:	5f                   	pop    edi
    138c:	5d                   	pop    ebp
    138d:	8d 61 fc             	lea    esp,[ecx-0x4]
    1390:	c3                   	ret    
