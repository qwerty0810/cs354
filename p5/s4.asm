...
00001100 <__cxa_finalize@plt>:
    1100:	ff a3 40 00 00 00    	jmp    DWORD PTR [ebx+0x40]
...
00001110 <_start>:
    ...
    1116:	5e                   	pop    esi
    1117:	89 e1                	mov    ecx,esp
    1119:	83 e4 f0             	and    esp,0xfffffff0
    111c:	50                   	push   eax
    111d:	54                   	push   esp
    111e:	52                   	push   edx
    111f:	e8 18 00 00 00       	call   113c <_start+0x2c>
    1124:	81 c3 88 2e 00 00    	add    ebx,0x2e88
    112a:	6a 00                	push   0x0
    112c:	6a 00                	push   0x0
    112e:	51                   	push   ecx
    112f:	56                   	push   esi
    1130:	ff b3 4c 00 00 00    	push   DWORD PTR [ebx+0x4c]
    1136:	e8 05 ff ff ff       	call   1040 <__libc_start_main@plt>
    113b:	f4                   	hlt    
    113c:	8b 1c 24             	mov    ebx,DWORD PTR [esp]
    113f:	c3                   	ret    
...
00001150 <deregister_tm_clones>:
    ...
    1155:	81 c2 57 2e 00 00    	add    edx,0x2e57
    115b:	8d 8a 70 00 00 00    	lea    ecx,[edx+0x70]
    1161:	8d 82 70 00 00 00    	lea    eax,[edx+0x70]
    1167:	39 c8                	cmp    eax,ecx
    1169:	74 1d                	je     1188 <deregister_tm_clones+0x38>
    116b:	8b 82 3c 00 00 00    	mov    eax,DWORD PTR [edx+0x3c]
...
00001190 <register_tm_clones>:
    ...
    1195:	81 c2 17 2e 00 00    	add    edx,0x2e17
    119b:	55                   	push   ebp
    119c:	89 e5                	mov    ebp,esp
    119e:	53                   	push   ebx
    119f:	8d 8a 70 00 00 00    	lea    ecx,[edx+0x70]
    11a5:	8d 82 70 00 00 00    	lea    eax,[edx+0x70]
    ...
    11be:	8b 92 50 00 00 00    	mov    edx,DWORD PTR [edx+0x50]
...
000011e0 <__do_global_dtors_aux>:
    ...
    11ed:	81 c3 bf 2d 00 00    	add    ebx,0x2dbf
    11f3:	83 ec 04             	sub    esp,0x4
    11f6:	80 bb 70 00 00 00 00 	cmp    BYTE PTR [ebx+0x70],0x0
    11fd:	75 27                	jne    1226 <__do_global_dtors_aux+0x46>
    11ff:	8b 83 40 00 00 00    	mov    eax,DWORD PTR [ebx+0x40]
    1205:	85 c0                	test   eax,eax
    1207:	74 11                	je     121a <__do_global_dtors_aux+0x3a>
    1209:	83 ec 0c             	sub    esp,0xc
    120c:	ff b3 58 00 00 00    	push   DWORD PTR [ebx+0x58]
    ...
    121f:	c6 83 70 00 00 00 01 	mov    BYTE PTR [ebx+0x70],0x1
    1226:	8b 5d fc             	mov    ebx,DWORD PTR [ebp-0x4]
    1229:	c9                   	leave  
    122a:	c3                   	ret    
    122b:	8d 74 26 00          	lea    esi,[esi+eiz*1+0x0]
    122f:	90                   	nop
...
0000123d <fail>:
    123d:	56                   	push   esi
    123e:	53                   	push   ebx
    123f:	83 ec 10             	sub    esp,0x10
    1242:	e8 f9 fe ff ff       	call   1140 <__x86.get_pc_thunk.bx>
    1247:	81 c3 65 2d 00 00    	add    ebx,0x2d65
    124d:	6a 01                	push   0x1
    124f:	e8 1c fe ff ff       	call   1070 <sleep@plt>
    1254:	8d b3 5c e0 ff ff    	lea    esi,[ebx-0x1fa4]
    125a:	89 34 24             	mov    DWORD PTR [esp],esi
    125d:	e8 3e fe ff ff       	call   10a0 <puts@plt>
    1262:	8d 83 84 e0 ff ff    	lea    eax,[ebx-0x1f7c]
    1268:	89 04 24             	mov    DWORD PTR [esp],eax
    126b:	e8 30 fe ff ff       	call   10a0 <puts@plt>
    1270:	89 34 24             	mov    DWORD PTR [esp],esi
    1273:	e8 28 fe ff ff       	call   10a0 <puts@plt>
    1278:	c7 04 24 01 00 00 00 	mov    DWORD PTR [esp],0x1
    127f:	e8 2c fe ff ff       	call   10b0 <exit@plt>

00001284 <success>:
    1284:	56                   	push   esi
    1285:	53                   	push   ebx
    1286:	83 ec 10             	sub    esp,0x10
    1289:	e8 b2 fe ff ff       	call   1140 <__x86.get_pc_thunk.bx>
    128e:	81 c3 1e 2d 00 00    	add    ebx,0x2d1e
    1294:	6a 01                	push   0x1
    1296:	e8 d5 fd ff ff       	call   1070 <sleep@plt>
    129b:	8d b3 ac e0 ff ff    	lea    esi,[ebx-0x1f54]
    12a1:	89 34 24             	mov    DWORD PTR [esp],esi
    12a4:	e8 f7 fd ff ff       	call   10a0 <puts@plt>
    12a9:	8d 83 d0 e0 ff ff    	lea    eax,[ebx-0x1f30]
    12af:	89 04 24             	mov    DWORD PTR [esp],eax
    12b2:	e8 e9 fd ff ff       	call   10a0 <puts@plt>
    12b7:	89 34 24             	mov    DWORD PTR [esp],esi
    12ba:	e8 e1 fd ff ff       	call   10a0 <puts@plt>
    12bf:	83 c4 14             	add    esp,0x14
    12c2:	5b                   	pop    ebx
    12c3:	5e                   	pop    esi
    12c4:	c3                   	ret    
...
000012c5 <insert1>:
    12c5:	53                   	push   ebx
    12c6:	83 ec 14             	sub    esp,0x14
    12c9:	e8 72 fe ff ff       	call   1140 <__x86.get_pc_thunk.bx>
    12ce:	81 c3 de 2c 00 00    	add    ebx,0x2cde
    12d4:	6a 08                	push   0x8
    12d6:	e8 b5 fd ff ff       	call   1090 <malloc@plt>
    12db:	83 c4 10             	add    esp,0x10
    12de:	85 c0                	test   eax,eax
    12e0:	74 1a                	je     12fc <insert1+0x37>
    12e2:	8b 54 24 10          	mov    edx,DWORD PTR [esp+0x10]
    12e6:	89 10                	mov    DWORD PTR [eax],edx
    12e8:	8b 93 74 00 00 00    	mov    edx,DWORD PTR [ebx+0x74]
    12ee:	89 50 04             	mov    DWORD PTR [eax+0x4],edx
    12f1:	89 83 74 00 00 00    	mov    DWORD PTR [ebx+0x74],eax
    12f7:	83 c4 08             	add    esp,0x8
    12fa:	5b                   	pop    ebx
    12fb:	c3                   	ret    
    12fc:	8d 83 28 e1 ff ff    	lea    eax,[ebx-0x1ed8]
    1302:	50                   	push   eax
    1303:	6a 16                	push   0x16
    1305:	8d 83 f4 e0 ff ff    	lea    eax,[ebx-0x1f0c]
    130b:	50                   	push   eax
    130c:	8d 83 fd e0 ff ff    	lea    eax,[ebx-0x1f03]
    1312:	50                   	push   eax
    1313:	e8 d8 fd ff ff       	call   10f0 <__assert_fail@plt>

00001318 <insert2>:
    1318:	53                   	push   ebx
    1319:	83 ec 14             	sub    esp,0x14
    131c:	e8 1f fe ff ff       	call   1140 <__x86.get_pc_thunk.bx>
    1321:	81 c3 8b 2c 00 00    	add    ebx,0x2c8b
    1327:	6a 08                	push   0x8
    1329:	e8 62 fd ff ff       	call   1090 <malloc@plt>
    132e:	83 c4 10             	add    esp,0x10
    1331:	85 c0                	test   eax,eax
    1333:	74 2f                	je     1364 <insert2+0x4c>
    1335:	8b 54 24 10          	mov    edx,DWORD PTR [esp+0x10]
    1339:	89 10                	mov    DWORD PTR [eax],edx
    133b:	c7 40 04 00 00 00 00 	mov    DWORD PTR [eax+0x4],0x0
    1342:	8b 8b 74 00 00 00    	mov    ecx,DWORD PTR [ebx+0x74]
    1348:	85 c9                	test   ecx,ecx
    134a:	74 34                	je     1380 <insert2+0x68>
    134c:	8b 51 04             	mov    edx,DWORD PTR [ecx+0x4]
    134f:	85 d2                	test   edx,edx
    1351:	74 09                	je     135c <insert2+0x44>
    1353:	89 d1                	mov    ecx,edx
    1355:	8b 52 04             	mov    edx,DWORD PTR [edx+0x4]
    1358:	85 d2                	test   edx,edx
    135a:	75 f7                	jne    1353 <insert2+0x3b>
    135c:	89 41 04             	mov    DWORD PTR [ecx+0x4],eax
    135f:	83 c4 08             	add    esp,0x8
    1362:	5b                   	pop    ebx
    1363:	c3                   	ret    
    1364:	8d 83 20 e1 ff ff    	lea    eax,[ebx-0x1ee0]
    136a:	50                   	push   eax
    136b:	6a 1f                	push   0x1f
    136d:	8d 83 f4 e0 ff ff    	lea    eax,[ebx-0x1f0c]
    1373:	50                   	push   eax
    1374:	8d 83 fd e0 ff ff    	lea    eax,[ebx-0x1f03]
    137a:	50                   	push   eax
    137b:	e8 70 fd ff ff       	call   10f0 <__assert_fail@plt>
    1380:	89 83 74 00 00 00    	mov    DWORD PTR [ebx+0x74],eax
    1386:	eb d7                	jmp    135f <insert2+0x47>

00001388 <pop>:
    1388:	56                   	push   esi
    1389:	53                   	push   ebx
    138a:	83 ec 10             	sub    esp,0x10
    138d:	e8 ae fd ff ff       	call   1140 <__x86.get_pc_thunk.bx>
    1392:	81 c3 1a 2c 00 00    	add    ebx,0x2c1a
    1398:	8b 83 74 00 00 00    	mov    eax,DWORD PTR [ebx+0x74]
    139e:	8b 50 04             	mov    edx,DWORD PTR [eax+0x4]
    13a1:	89 93 74 00 00 00    	mov    DWORD PTR [ebx+0x74],edx
    13a7:	8b 30                	mov    esi,DWORD PTR [eax]
    13a9:	50                   	push   eax
    13aa:	e8 a1 fc ff ff       	call   1050 <free@plt>
    13af:	89 f0                	mov    eax,esi
    13b1:	83 c4 14             	add    esp,0x14
    13b4:	5b                   	pop    ebx
    13b5:	5e                   	pop    esi
    13b6:	c3                   	ret    
...
000013b7 <dump>:
    ...
    13bf:	81 c3 ed 2b 00 00    	add    ebx,0x2bed
    13c5:	8b b3 74 00 00 00    	mov    esi,DWORD PTR [ebx+0x74]
    13cb:	85 f6                	test   esi,esi
    13cd:	74 1d                	je     13ec <dump+0x35>
    13cf:	8d bb 07 e1 ff ff    	lea    edi,[ebx-0x1ef9]
    13d5:	83 ec 04             	sub    esp,0x4
    13d8:	ff 36                	push   DWORD PTR [esi]
    13da:	57                   	push   edi
    13db:	6a 01                	push   0x1
    13dd:	e8 ee fc ff ff       	call   10d0 <__printf_chk@plt>
    13e2:	8b 76 04             	mov    esi,DWORD PTR [esi+0x4]
    13e5:	83 c4 10             	add    esp,0x10
...
000013f0 <main>:
    13f0:	8d 4c 24 04          	lea    ecx,[esp+0x4]
    13f4:	83 e4 f0             	and    esp,0xfffffff0
    13f7:	ff 71 fc             	push   DWORD PTR [ecx-0x4]
    13fa:	55                   	push   ebp
    13fb:	89 e5                	mov    ebp,esp
    13fd:	57                   	push   edi
    13fe:	56                   	push   esi
    13ff:	53                   	push   ebx
    1400:	51                   	push   ecx
    1401:	81 ec 28 02 00 00    	sub    esp,0x228
    1407:	e8 34 fd ff ff       	call   1140 <__x86.get_pc_thunk.bx>
    140c:	81 c3 a0 2b 00 00    	add    ebx,0x2ba0
    1412:	8b 51 04             	mov    edx,DWORD PTR [ecx+0x4]
    1415:	65 a1 14 00 00 00    	mov    eax,gs:0x14
    141b:	89 45 e4             	mov    DWORD PTR [ebp-0x1c],eax
    141e:	31 c0                	xor    eax,eax
    1420:	8b 83 48 00 00 00    	mov    eax,DWORD PTR [ebx+0x48]
    1426:	8b 38                	mov    edi,DWORD PTR [eax]
    1428:	83 39 02             	cmp    DWORD PTR [ecx],0x2
    142b:	74 6a                	je     1497 <main+0xa7>
    142d:	83 ec 0c             	sub    esp,0xc
    1430:	ff b3 64 00 00 00    	push   DWORD PTR [ebx+0x64]
    1436:	e8 8a fe ff ff       	call   12c5 <insert1>
    143b:	83 c4 04             	add    esp,0x4
    143e:	ff b3 68 00 00 00    	push   DWORD PTR [ebx+0x68]
    1444:	e8 cf fe ff ff       	call   1318 <insert2>
    1449:	83 c4 04             	add    esp,0x4
    144c:	ff b3 5c 00 00 00    	push   DWORD PTR [ebx+0x5c]
    1452:	e8 6e fe ff ff       	call   12c5 <insert1>
    1457:	83 c4 04             	add    esp,0x4
    145a:	ff b3 6c 00 00 00    	push   DWORD PTR [ebx+0x6c]
    1460:	e8 60 fe ff ff       	call   12c5 <insert1>
    1465:	83 c4 04             	add    esp,0x4
    1468:	ff b3 68 00 00 00    	push   DWORD PTR [ebx+0x68]
    146e:	e8 52 fe ff ff       	call   12c5 <insert1>
    1473:	83 c4 04             	add    esp,0x4
    1476:	ff b3 60 00 00 00    	push   DWORD PTR [ebx+0x60]
    147c:	e8 44 fe ff ff       	call   12c5 <insert1>
    1481:	83 c4 10             	add    esp,0x10
    1484:	be 01 00 00 00       	mov    esi,0x1
    1489:	8b 83 48 00 00 00    	mov    eax,DWORD PTR [ebx+0x48]
    148f:	89 85 d0 fd ff ff    	mov    DWORD PTR [ebp-0x230],eax
    1495:	eb 35                	jmp    14cc <main+0xdc>
    1497:	83 ec 08             	sub    esp,0x8
    149a:	8d 83 0b e1 ff ff    	lea    eax,[ebx-0x1ef5]
    14a0:	50                   	push   eax
    14a1:	ff 72 04             	push   DWORD PTR [edx+0x4]
    ...
    14b3:	83 ec 04             	sub    esp,0x4
    14b6:	56                   	push   esi
    14b7:	ff b5 d4 fd ff ff    	push   DWORD PTR [ebp-0x22c]
    14bd:	6a 01                	push   0x1
    14bf:	e8 0c fc ff ff       	call   10d0 <__printf_chk@plt>
    14c4:	83 c4 10             	add    esp,0x10
    14c7:	eb 1e                	jmp    14e7 <main+0xf7>
    14c9:	83 c6 01             	add    esi,0x1
    14cc:	8d 83 0d e1 ff ff    	lea    eax,[ebx-0x1ef3]
    14d2:	89 85 d4 fd ff ff    	mov    DWORD PTR [ebp-0x22c],eax
    14d8:	83 fe 06             	cmp    esi,0x6
    14db:	74 5b                	je     1538 <main+0x148>
    14dd:	8b 85 d0 fd ff ff    	mov    eax,DWORD PTR [ebp-0x230]
    14e3:	39 38                	cmp    DWORD PTR [eax],edi
    14e5:	74 cc                	je     14b3 <main+0xc3>
    14e7:	83 ec 04             	sub    esp,0x4
    14ea:	57                   	push   edi
    14eb:	68 00 02 00 00       	push   0x200
    14f0:	8d 85 e4 fd ff ff    	lea    eax,[ebp-0x21c]
    14f6:	50                   	push   eax
    14f7:	e8 64 fb ff ff       	call   1060 <fgets@plt>
    14fc:	83 c4 10             	add    esp,0x10
    14ff:	85 c0                	test   eax,eax
    1501:	74 d5                	je     14d8 <main+0xe8>
    1503:	83 ec 04             	sub    esp,0x4
    1506:	6a 0a                	push   0xa
    1508:	6a 00                	push   0x0
    150a:	8d 85 e4 fd ff ff    	lea    eax,[ebp-0x21c]
    1510:	50                   	push   eax
    1511:	e8 ca fb ff ff       	call   10e0 <strtol@plt>
    1516:	89 85 d4 fd ff ff    	mov    DWORD PTR [ebp-0x22c],eax
    151c:	e8 67 fe ff ff       	call   1388 <pop>
    1521:	89 c2                	mov    edx,eax
    1523:	8b 85 d4 fd ff ff    	mov    eax,DWORD PTR [ebp-0x22c]
    1529:	83 c0 02             	add    eax,0x2
    152c:	83 c4 10             	add    esp,0x10
    152f:	39 c2                	cmp    edx,eax
    1531:	74 96                	je     14c9 <main+0xd9>
    1533:	e8 05 fd ff ff       	call   123d <fail>
    1538:	e8 47 fd ff ff       	call   1284 <success>
    153d:	8b 45 e4             	mov    eax,DWORD PTR [ebp-0x1c]
    1540:	65 2b 05 14 00 00 00 	sub    eax,DWORD PTR gs:0x14
    1547:	75 11                	jne    155a <main+0x16a>
    1549:	b8 00 00 00 00       	mov    eax,0x0
    154e:	8d 65 f0             	lea    esp,[ebp-0x10]
    1551:	59                   	pop    ecx
    1552:	5b                   	pop    ebx
    1553:	5e                   	pop    esi
    1554:	5f                   	pop    edi
    1555:	5d                   	pop    ebp
    1556:	8d 61 fc             	lea    esp,[ecx-0x4]
    1559:	c3                   	ret    
...
00001560 <__stack_chk_fail_local>:
    ...
    156a:	81 c3 42 2a 00 00    	add    ebx,0x2a42
    1570:	83 ec 08             	sub    esp,0x8
...
00001578 <_fini>:
    ...
    157c:	53                   	push   ebx
    157d:	83 ec 08             	sub    esp,0x8
    1580:	e8 bb fb ff ff       	call   1140 <__x86.get_pc_thunk.bx>
    1585:	81 c3 27 2a 00 00    	add    ebx,0x2a27
    158b:	83 c4 08             	add    esp,0x8
    158e:	5b                   	pop    ebx
    158f:	c3                   	ret    
